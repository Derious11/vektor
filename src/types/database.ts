  ...
  public: {
    Tables: {
      ...
      role_commands: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_commands_command_id_fkey"
            columns: ["command_id"]
            isOneToOne: false
            referencedRelation: "commands"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "role_commands_role_id_fkey"
            columns: ["role_id"]
            isOneToOne: false
      ...
      saved_prompts: {
        ...
        Relationships: [
          {
            foreignKeyName: "saved_prompts_format_id_fkey"
            columns: ["format_id"]
            isOneToOne: false
            referencedRelation: "formats"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "saved_prompts_role_id_fkey"
            columns: ["role_id"]
            isOneToOne: false
            referencedRelation: "roles"
            referencedColumns: ["id"]
